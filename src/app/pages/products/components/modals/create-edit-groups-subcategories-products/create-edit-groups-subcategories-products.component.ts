...
export class CreateEditGroupsSubcategoriesProductsComponent implements OnInit {
    ...
    public groupCreate: GroupModal = {
        name: 'create', groupCategoryProduct: null, groupSubCategoryProduct: null,
        groupName: null, groupDescription: null
    };
    public groupEdit: GroupModal = {
        name: 'edit', groupCategoryProduct: null, groupSubCategoryProduct: null,
        groupName: null, groupDescription: null
    };
